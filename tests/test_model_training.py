...
def test_model_release_report_matches_source_reports() -> None:
    ...
    assert stock_candidate_labeling["candidate_count"] == 12481
    ...
    assert stock_candidate_labeling["accepted_count_by_primary_label"]["CONTRACT"] == 237
...
def test_pseudo_label_monitoring_report_matches_source_reports() -> None:
    ...
    assert monitoring_report["candidate_funnel"]["raw_candidate_count"] == 57045
