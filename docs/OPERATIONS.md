...
- 현재 artifact는 59,485건 수집 후보 중 weak-label 353건과 종목 후보 큐 738건을 이벤트 모델 학습에 반영했다.
...
- 현재 59,485건 raw 후보 중 5,069건이 고신호 후보이고, teacher gate에서 3,813건이 탈락하며 weak-label 353건과 종목 후보 738건만 student 이벤트 모델 학습에 승격된다.
