...
- 종목 후보 큐 승격분은 per-stock quota 1건으로 제한해 464건이 464개 종목에 분산되도록 한다.
...
- 현재 37,278건 raw 후보 중 4,845건이 고신호 후보이고, teacher gate에서 3,124건이 탈락하며 weak-label 360건과 종목 후보 464건만 student 이벤트 모델 학습에 승격된다.
