...
- 현재 artifact는 57,078건 수집 후보 중 weak-label 358건과 종목 후보 큐 704건을 이벤트 모델 학습에 반영했다.
...
- 현재 57,078건 raw 후보 중 5,050건이 고신호 후보이고, teacher gate에서 3,747건이 탈락하며 weak-label 358건과 종목 후보 704건만 student 이벤트 모델 학습에 승격된다.
