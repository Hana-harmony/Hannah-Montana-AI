...
| 글로벌 피어 매칭 | TF-IDF + SVD semantic + 재무/업종 feature + pairwise LogisticRegression reranker | curated pairwise top1 0.9286, top3 1.0, 전종목 3,967/3,967 추론 성공, LOW confidence 29.7454% | pass |
...
## 남은 개선
- 글로벌 피어 LOW confidence 비율은 국내 동일업종 feature 보강 전 75.4726%에서 29.7454%로 낮아졌고 monitoring target 35%를 통과한다.
- 국내 업종 profile은 Naver 동일업종 비교 데이터 2,649개를 수집했고, 2,451개는 generic이 아닌 specific sector/industry feature를 제공한다.
