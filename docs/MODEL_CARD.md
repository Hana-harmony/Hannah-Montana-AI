...
## 모델명
`financial-ml-tfidf-logreg-20260604142946`
...
- 이벤트 태그 probability threshold는 기본 0.30으로 두고, 실제 뉴스 gold 기준으로 `CORPORATE_ACTION` 0.16, `EARNINGS` 0.42, `RISK` 0.42를 label별 calibration했다.
...
- 평가 샘플 수: 80
- 이벤트 태그 recall: 0.9750
- 이벤트 태그 macro F1: 0.9006
- 감성 accuracy: 0.9125
- 중요도 accuracy: 0.9250
- 종목 매핑 accuracy: 1.0
...
- 현재 모델 버전: `financial-ml-tfidf-logreg-20260604142946`
- 전체 상태: `pass`
